...
\* Run `modelator trace -t <TestName> IndicesHistoryTests.tla Indices.cfg` for a specific test
\* Run `modelator trace -n <NumTests> IndicesHistoryTests.tla Indices.cfg` for multiple tests
